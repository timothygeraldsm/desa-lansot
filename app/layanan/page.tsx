...
export default function LayananPage() {
  const governmentStaff = [
    ...
    { 
      position: "Staf Desa",
      name: "THAMSIN R. THAMRIN",
      phone: "",
      photo: "/foto/Staff Desa.png" 
    },
  ]
                ...
                {/* Profile Photo */}
                  ...
                  <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-white shadow-lg">
                    <Image
                      ...
                      width={96}
                      height={96}
                      className="w-full h-full object-cover scale-110" // tambahkan scale-110 di sini
